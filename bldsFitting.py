...
def main(args=None):
    ...
    parser.add_argument('offset_x', type=double, help='offset x')
    parser.add_argument('offset_y', type=double, help='offset y')
    parser.add_argument('offset_z', type=double, help='offset z')
    parser.add_argument('scale', type=double, help='scale')
