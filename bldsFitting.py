...
def main(args=None):
    ...
    parser.add_argument('input_vdb', type=str, required=True, help='input vdb filename')
    parser.add_argument('input_binary', type=str, required=True, help='input binary filename')
    parser.add_argument('output', type=str, required=True, help='output ply filename')
    #parser.add_argument('-t', '--threshold', type=float, help='threshold')
    parser.add_argument('-w', '--weight', type=float, required=True, help='The relative weight of accuracy term to the simplicity term [0, 1].')
